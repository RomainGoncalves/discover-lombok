    ...
    <div class="banner navbar navbar-static-top navbar-inverse">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="index.html"><img src="<?php echo stripslashes( $data['ct_logo_upload'] ) ?>"></a>
            ...
            <ul class="pull-right unstyled social-icons">
              <li class="pull-left">
                <a href="https://www.facebook.com/pages/Discover-Lombok/452346518178357">
                  <img src="<?php echo get_template_directory_uri() ; ?>/homepage-template/assets/img/facebook.png" class="icons">
                </a>
              </li>
              <li class="pull-left">
                <a href="https://twitter.com/Discover_Lombok">
                  <img src="<?php echo get_template_directory_uri() ; ?>/homepage-template/assets/img/twitter.png" class="icons">
                </a>
              </li>
              <li class="pull-left">
                <a href="http://instagram.com/discoverlombok">
                  <img src="<?php echo get_template_directory_uri() ; ?>/homepage-template/assets/img/instagram.png" class="icons">
                </a>
              </li>
              <li class="pull-left">
                <a href="https://plus.google.com/u/0/105008338029322758204/">
                  <img src="<?php echo get_template_directory_uri() ; ?>/homepage-template/assets/img/google.png" class="icons">
                </a>
              </li>
              <li class="pull-left">
                <a href="http://feeds.feedburner.com/DiscoverLombok">
                  <img src="<?php echo get_template_directory_uri() ; ?>/homepage-template/assets/img/rss.png" class="icons">
                </a>
              </li>
              <li class="pull-left">
                <a href="http://www.flickr.com/photos/mondeailleurs/sets/72157633148779264/">
                  <img src="<?php echo get_template_directory_uri() ; ?>/homepage-template/assets/img/flickr.png" class="icons">
                </a>
              </li>
            </ul>
          </div><!--/.nav-collapse -->
    ...
    <div id="hero">
      <div class="container">
        ...
        <div class="hero-title">
          <h1><?php echo bloginfo($show='name') ?></h1>
        </div>
