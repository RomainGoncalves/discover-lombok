...
//		$show_text = $instance['show_text'];
		...
		$show_facebook2 = isset($instance['show_facebook2']) ? 'true' : 'false';
	...
	<div id="entry-counters" class="border-1px">
	  <ul id="social-counter">
		...
		<li class="facebook-social">
		  ...
		  <?php echo '<span class="social">' . $facebook_english_format . '</span>'; ?></a>
		</li>
		<?php endif; ?>
		...
		<li class="twitter-social">
		  ...
		  <span class="arrow-down"></span>
		  <?php echo '<span class="social">' . $twitter_english_format . '</span>'; ?></a>
		</li>
		<?php endif; ?>
		...
		<li class="youtube-social">
		  ...
		  <span class="arrow-down"></span>
		  <?php echo '<span class="social">' . $youtube_english_format . '</span>'; ?></a>
		</li>
		<?php endif; ?>

		<?php if ( $show_rss == 'true') : ?>
		<li class="rss-social">
		  <a href="http://feeds.feedburner.com/<?php echo $rss_ID ?>"><span class="c-icon"></span>
		  <span class="arrow-down"></span>
		  <?php echo '<span class="social">' . __('RSS','color-theme-framework') . '</span>'; ?></a>
		</li>
		<?php endif; ?>		
		</ul>
	</div><!-- entry-counters -->
...
//		$instance['show_text'] = $new_instance['show_text'];
		...
		$instance['show_facebook2'] = $new_instance['show_facebook2'];
	...
	function form($instance){
		...
		<p>
			<input class="checkbox" type="checkbox" <?php checked($instance['show_facebook2'], 'on'); ?> id="<?php echo $this->get_field_id('show_facebook2'); ?>" name="<?php echo $this->get_field_name('show_facebook2'); ?>" /> 
			<label for="<?php echo $this->get_field_id('show_facebook2'); ?>"><?php _e( 'Show Counters' , 'color-theme-framework' ); ?></label>
		</p>
