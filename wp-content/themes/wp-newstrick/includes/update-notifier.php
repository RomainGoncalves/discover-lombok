...
define( 'NOTIFIER_THEME_NAME', 'NewsTrick' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'wp-newstrick' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://color-theme.com/tools/notifier/newstrick/notifier.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
